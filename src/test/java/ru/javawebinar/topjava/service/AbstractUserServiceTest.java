...
public abstract class AbstractUserServiceTest extends AbstractServiceTest {
    ...
    @Test
    public void getByInvalidEmail() {
        assertThrows(NotFoundException.class, () -> service.getByEmail("ilove@go.com"));
    }
    ...
    public void createWithException() throws Exception {
        Assume.assumeTrue("Validation supported only for JPA profile", isJpa());
